...
ytvos_category_dict = {
    ...
    'motorbike': 34, 'mouse': 35, 'others': 36, 'targets': 36, 'owl': 37, 'paddle': 38, 'parachute': 39, 'parrot': 40, 'penguin': 41, 
...
ytvos_category_list = [
    ...
    'monkey', 'motorbike', 'mouse', 'others', 'targets', 'owl', 'paddle', 'parachute', 'parrot', 'penguin', 'person', 
