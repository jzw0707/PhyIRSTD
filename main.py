...
def main(args):
    ...
    if args.resume:
        ...
        saved_best_metrics = (
            checkpoint.get("best_metrics", {}) if args.resume_optimizer else {}
        )
    ...
    if args.start_epoch >= args.epochs:
        raise ValueError(
            "Checkpoint already reached --epochs; set the intended total epoch budget"
        )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            utils.save_on_master(recovery_state, output_dir / "checkpoint.pth")
